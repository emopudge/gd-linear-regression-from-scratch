...
3. Выполните тесты:
   ...
   ```
4. Запустите пример использования (файл `example_usage.py` - `run` в IDE) (для простоты визуализируем только линейную регрессию зависимости цены и количества комнат)
